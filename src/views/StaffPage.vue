<template >
    <ion-page>
        <ion-content :scroll-y="false">
            ...
            <ion-segment :mode="'md'" :value="typseg" @ion-change="e => typseg = e.detail.value as any">
                <ion-segment-button @click="aides = [] ,typseg = 'aides'" value="aides">
                    <ion-label> Aides pour Cours/Exercices </ion-label>
                </ion-segment-button>
                <ion-segment-button @click="aides = [] ,typseg = 'conseils'" value="conseils">
...
watch(filter_name, (newf, oldf) => {
    if (newf != "Filtrer") aides.value = [] ,get_aides()
})
